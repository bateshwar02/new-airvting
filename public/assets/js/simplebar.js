...
(function(global, factory) {
    ...
    const _core = createCommonjsModule(function(module) {
        const core = (module.exports = { version: '2.6.2' });
    ...
    const _shared = createCommonjsModule(function(module) {
    ...
    var $export = function(type, name, source) {
        ...
        const target = IS_GLOBAL ? _global : IS_STATIC ? _global[name] || (_global[name] = {}) : (_global[name] || {})[PROTOTYPE];
    ...
    const REPLACE_SUPPORTS_NAMED_GROUPS = !_fails(function() {
    ...
    const _fixReWks = function(KEY, length, exec) {
        ...
        const DELEGATES_TO_SYMBOL = !_fails(function() {
        ...
        if (
            ...
            const fns = exec(_defined, SYMBOL, ''[KEY], function maybeCallNative(nativeMethod, regexp, str, arg2, forceStringMethod) {
        ...
        return [
            ...
            function(regexp, replaceValue) {
                ...
                for (let i = 0; i < results.length; i++) {
                    ...
                    const position = max(min$1(_toInteger(result.index), S.length), 0);
                    const captures = [];
    ...
    for (let collections = _objectKeys(DOMIterables), i = 0; i < collections.length; i++) {
    ...
    const scrollbarWidth = createCommonjsModule(function(module, exports) {
    ...
    /** Built-in method references without a dependency on `root`. */
    const freeParseInt$1 = parseInt;

    /** Detect free variable `global` from Node.js. */
    const freeGlobal$1 = typeof commonjsGlobal === 'object' && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal;

    /** Detect free variable `self`. */
    const freeSelf$1 = typeof self === 'object' && self && self.Object === Object && self;

    /** Used as a reference to the global object. */
    const root$1 = freeGlobal$1 || freeSelf$1 || Function('return this')();
     ...
     * of values.
     */
    const objectToString$1 = objectProto$1.toString;

    /* Built-in method references for those with the same name as other `lodash` methods. */
    const nativeMax$1 = Math.max;
    const nativeMin$1 = Math.min;
    ...
    function toNumber$1(value) {
        ...
        const isBinary = reIsBinary$1.test(value);
        return isBinary || reIsOctal$1.test(value) ? freeParseInt$1(value.slice(2), isBinary ? 2 : 8) : reIsBadHex$1.test(value) ? NAN$1 : +value;
    }

    const lodash_debounce = debounce$1;
    ...
    /** Used as the `TypeError` message for "Functions" methods. */
    const FUNC_ERROR_TEXT$2 = 'Expected a function';
    ...
    /** Detect free variable `global` from Node.js. */
    const freeGlobal$2 = typeof commonjsGlobal === 'object' && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal;

    /** Detect free variable `self`. */
    const freeSelf$2 = typeof self === 'object' && self && self.Object === Object && self;

    /** Used as a reference to the global object. */
    const root$2 = freeGlobal$2 || freeSelf$2 || Function('return this')();
    ...
    const coreJsData = root$2['__core-js_shared__'];
     ...
     * of values.
     */
    const objectToString$2 = objectProto$2.toString;
    ...
    const Map$1 = getNative(root$2, 'Map');
    ...
    function isFunction(value) {
        ...
        const tag = isObject$2(value) ? objectToString$2.call(value) : '';
        ...
        (function() {
            function SimpleBar(element, options) {
                ...
                this.drag = function(e) {
                    let eventOffset;
                    const { track } = _this.axis[_this.draggedAxis];
                    const trackSize = track.rect[_this.axis[_this.draggedAxis].sizeAttr];
                    const { scrollbar } = _this.axis[_this.draggedAxis];
                    e.preventDefault();
                    e.stopPropagation();
                    ...
                    const dragPerc = dragPos / track.rect[_this.axis[_this.draggedAxis].sizeAttr]; // Scroll the content by the same percentage.

                    let scrollPos = dragPerc * _this.contentEl[_this.axis[_this.draggedAxis].scrollSizeAttr]; // Fix browsers inconsistency on RTL
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function recalculate() {
                            ...
                            this.axis.x.isOverflowing =
                                (this.scrollbarWidth ? this.contentEl.scrollWidth : this.contentEl.scrollWidth - this.minScrollbarWidth) >
                                Math.ceil(this.axis.x.track.rect.width);
                            this.axis.y.isOverflowing =
                                (this.scrollbarWidth ? this.contentEl.scrollHeight : this.contentEl.scrollHeight - this.minScrollbarWidth) >
                    ...
                    },
                    {
                        ...
                        value: function getScrollbarSize() {
                            const axis = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'y';
                    ...
                    },
                    {
                        ...
                        value: function positionScrollbar() {
                            ...
                            scrollbar.el.style.transform =
                                axis === 'x' ? 'translate3d('.concat(handleOffset, 'px, 0, 0)') : 'translate3d(0, '.concat(handleOffset, 'px, 0)');
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function hideNativeScrollbar() {
                            this.offsetEl.style[this.isRtl ? 'left' : 'right'] =
                                this.axis.y.isOverflowing || this.axis.y.forceVisible ? '-'.concat(this.scrollbarWidth || this.minScrollbarWidth, 'px') : 0;
                            this.offsetEl.style.bottom =
                                this.axis.x.isOverflowing || this.axis.x.forceVisible ? '-'.concat(this.scrollbarWidth || this.minScrollbarWidth, 'px') : 0; // If floating scrollbar

                            if (!this.scrollbarWidth) {
                                const paddingDirection = [this.isRtl ? 'paddingLeft' : 'paddingRight'];
                                this.contentEl.style[paddingDirection] =
                                    this.axis.y.isOverflowing || this.axis.y.forceVisible
                                        ? 'calc('.concat(this.elStyles[paddingDirection], ' + ').concat(this.minScrollbarWidth, 'px)')
                                        : this.elStyles[paddingDirection];
                                this.contentEl.style.paddingBottom =
                                    this.axis.x.isOverflowing || this.axis.x.forceVisible
                                        ? 'calc('.concat(this.elStyles.paddingBottom, ' + ').concat(this.minScrollbarWidth, 'px)')
                    ...
                    },
                    {
                        ...
                        value: function onDragStart(e) {
                            const axis = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'y';
                            const scrollbar = this.axis[axis].scrollbar.el; // Measure how far the user's mouse is from the top of the scrollbar drag handle.
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function getElOptions(el) {
                            const options = Array.from(el.attributes).reduce(function(acc, attribute) {
