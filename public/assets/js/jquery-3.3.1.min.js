...
!(function(e, t) {
    ...
    (w.extend = w.fn.extend = function() {
        ...
        let u = arguments.length;
            let l = !1;
        for (
            typeof a === 'boolean' && ((l = a), (a = arguments[s] || {}), s++), typeof a === 'object' || g(a) || (a = {}), s === u && ((a = this), s--);
            s < u;
            s++
        )
        ...
        isPlainObject(e) {
            ...
            let n;
                return (
                    ...
                    (!(t = i(e)) || (typeof (n = f.call(t, 'constructor') && t.constructor) === 'function' && p.call(n) === d))
                );
            },
        isEmptyObject(e) {
                var t;
            ...
            return a !== d && a.nodeType === 9 && a.documentElement
                ...
                n.getById
                    ...
                    : ((r.filter.ID = function(e) {
                        var t = e.replace(Z, ee);
                        return function(e) {
                            const n = typeof e.getAttributeNode !== 'undefined' && e.getAttributeNode('id');
                            return n && n.value === t;
                        };
                    }),
                    (r.find.ID = function(e, t) {
        ...
        ((r = oe.selectors = {
            ...
            filter: {
                ...
                CHILD(e, t, n, r, i) {
                        ...
                        return r === 1 && i === 0
                            ...
                            var y = t.parentNode;
                                  let v = s && t.nodeName.toLowerCase();
                            const m = !u && !s;
                                  let x = !1;
                                  if (y) {
                                      if (o) {
                ...
                PSEUDO(e, t) {
                        let n;
                    let i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || oe.error(`unsupported pseudo: ${e}`);
                        return i[b]
                            ? i(t)
                            : i.length > 1
                            ? ((n = [e, e, '', t]),
            ...
            pseudos: {
                ...
                text(e) {
                        var t;
                        return (
                            e.nodeName.toLowerCase() === 'input' && e.type === 'text' && ((t = e.getAttribute('type')) == null || t.toLowerCase() === 'text')
                        );
                    },
                first: he(function() {
                    return [0];
    ...
    function De(e, t, n, r, i, o) {
        ...
        if (
            (r == null && i == null
                ? ((i = n), (r = n = void 0))
                : i == null && (typeof n === 'string' ? ((i = r), (r = void 0)) : ((i = r), (r = n), (n = void 0))),
            !1 === i)
        )
            i = ke;
        else if (!i) return e;
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, w.map(s, Oe), f = 0; f < u; f++)
                    ...
                    he.test(l.type || '') &&
                            ...
                            w.contains(c, l) &&
                            (l.src && (l.type || '').toLowerCase() !== 'module' ? w._evalUrl && w._evalUrl(l.src) : m(l.textContent.replace(qe, ''), c, l));
        }
        return e;
    }
    function Ie(e, t, n) {
    ...
    w.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; (e = this[t]) != null; t++) e.nodeType === 1 && (w.cleanData(ye(e, !1)), (e.textContent = ''));
            return this;
        },
        clone(e, t) {
                return (
    ...
    function Ze(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            ...
            r
                ? (n === 'content' && (u -= w.css(e, `padding${oe[a]}`, !0, i)), n !== 'margin' && (u -= w.css(e, `border${oe[a]}Width`, !0, i)))
                : ((u += w.css(e, `padding${oe[a]}`, !0, i)),
                n !== 'padding' ? (u += w.css(e, `border${oe[a]}Width`, !0, i)) : (s += w.css(e, `border${oe[a]}Width`, !0, i)));
    ...
    function et(e, t, n) {
        ...
        return (
            ...
            (i === 'auto' || (!parseFloat(i) && w.css(e, 'display', !1, r) === 'inline')) && ((i = e[`offset${t[0].toUpperCase()}${t.slice(1)}`]), (a = !0)),
    ...
    w.extend({
        ...
        style(e, t, n, r) {
            if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
                ...
                (o = typeof n) == 'string' && (i = ie.exec(n)) && i[1] && ((n = ue(e, t, i)), (o = 'number')),
                    n != null &&
                        n === n &&
            ...
            set(e, n, r) {
                ...
                let s = r && Ze(e, t, r, a, o);
                    return (
                        ...
                        s && (i = ie.exec(n)) && (i[3] || 'px') !== 'px' && ((e.style[t] = n), (n = w.css(e, t))),
                        Ke(e, n, s)
                    );
                },
        };
    ...
    (tt.propHooks = {
        _default: {
            ...
            set(e) {
                    w.fx.step[e.prop]
                        ? w.fx.step[e.prop](e)
                        : e.elem.nodeType !== 1 || (e.elem.style[w.cssProps[e.prop]] == null && !w.cssHooks[e.prop])
                        ? (e.elem[e.prop] = e.now)
    ...
    function ct(e, t, n) {
        ...
        if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d)) {
            f &&
                ...
                (c = w.css(e, 'display')) === 'none' && (l ? (c = l) : (fe([e], !0), (l = e.style.display || l), (c = w.css(e, 'display')), fe([e]))),
    ...
    function pt(e, t, n) {
        ...
        const s = w.Deferred().always(function() {
            delete u.elem;
        });
        var u = function() {
            if (i) return !1;
    ...
    (w.speed = function(e, t, n) {
        const r =
                e && typeof e === 'object' ? w.extend({}, e) : { complete: n || (!n && t) || (g(e) && e), duration: e, easing: (n && t) || (t && !g(t) && t) };
        return (
            w.fx.off
                ? (r.duration = 0)
        ...
        attr(e, t, n) {
                ...
                if (o !== 3 && o !== 8 && o !== 2)
                    return typeof e.getAttribute === 'undefined'
                        ? w.prop(e, t, n)
                        : ((o === 1 && w.isXMLDoc(e)) || (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? dt : void 0)),
                          void 0 !== n
                              ? n === null
    ...
    w.extend({
        ...
        ajax(t, n) {
            ...
            (f = w.event && h.global) && w.active++ == 0 && w.event.trigger('ajaxStart'),
                ...
                (o = h.url.replace(Lt, '')),
                h.hasContent
                    ? h.data && h.processData && (h.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && (h.data = h.data.replace(qt, '+'))
                    : ((d = h.url.slice(o.length)),
                      h.data && (h.processData || typeof h.data === 'string') && ((o += (kt.test(o) ? '&' : '?') + h.data), delete h.data),
    ...
    w.ajaxPrefilter('json jsonp', function(t, n, r) {
        ...
        const s =
                ...
                (Qt.test(t.url)
                    ? 'url'
                    : typeof t.data === 'string' && (t.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 && Qt.test(t.data) && 'data');
