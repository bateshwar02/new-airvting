...
function create(overrides = {}) {
  ...
  checkbox.getConfig = overrides.getConfig
        || function getConfig(locals) {
          return new CheckboxConfig(locals.config || {});
        };

  checkbox.getAttrs = overrides.getAttrs
  ...
  checkbox.renderStatic = overrides.renderStatic
  ...
  checkbox.renderCheckbox = overrides.renderCheckbox
  ...
  checkbox.renderLabel = overrides.renderLabel
  ...
  checkbox.renderError = overrides.renderError
        || function renderError(locals) {
          return getError(locals);
        };

  checkbox.renderHelp = overrides.renderHelp
        || function renderHelp(locals) {
          return getHelp(locals);
        };

  checkbox.renderVertical = overrides.renderVertical
  ...
  checkbox.renderHorizontal = overrides.renderHorizontal
