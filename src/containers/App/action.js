...
import {
  NOTIFICATION_SUCCESS, NOTIFICATION_ERROR, NOTIFICATION_WARN, UPDATE_USER_DATA, GET_USERS_SAGA, UPDATE_VIDEO_OBJ, LOGOUT, IS_ADD_PRODUCT, GET_NOTIFICATION, UPDATE_NOTIFICATION, UPDATE_MESSAGE, GET_MESSAGE, UPDATE_IN_PROCCESS, VERIFY_EMAIL, UPDATE_SEARCH, CART_DATA
} from './constants';
...
export function getCartData(isSearch) {
  return {
    type: CART_DATA,
    isSearch
  };
